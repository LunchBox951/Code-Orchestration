...
const COORDINATOR_GUIDANCE = [
  ...
  '  • LOCK — a spec is locked by the OPERATOR, not you: after drafting, request the operator’s bless',
  '    and WAIT for it. You cannot lock your own spec, and the steps below stay blocked until it is',
  '    locked — planning against an unlocked spec is wasted work.',
